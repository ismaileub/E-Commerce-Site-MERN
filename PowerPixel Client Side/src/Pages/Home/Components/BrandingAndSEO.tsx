        ...
        <div className="mb-16">
          ...
          <div className="flex flex-wrap gap-4 items-center justify-start">
            {brands.map((brand, index) => (
              <div
                key={index}
                className="w-32 h-20 bg-white border border-slate-200 rounded-lg flex items-center justify-center p-4 hover:shadow-md transition-shadow grayscale hover:grayscale-0 cursor-pointer"
              >
                <img
                  src={brand.logo}
                  alt={brand.name}
          ...
          >
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed text-sm lg:text-base">
              <p>
                ...
                <span className="text-cyan-700 font-medium">monitors</span>,
              ...
              <p>
                A <span className="text-cyan-700 font-medium">Smartwatch</span>{" "}
                is a <span className="text-cyan-700 font-medium">watch</span>{" "}
          ...
          {!isExpanded && (
            <div className="mt-6 flex justify-center relative z-10">
              <button
                ...
                className="flex items-center gap-2 px-6 py-2 bg-cyan-700 hover:bg-cyan-800 text-white font-bold rounded-md transition-colors text-sm shadow-sm"
              >
